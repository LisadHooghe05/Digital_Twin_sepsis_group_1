...
def create_AKI_90day_matrix():
    ...
    # Aantal rijen waar AKI_time wél aanwezig is
    ...
    # Filter alleen de subject_ids uit aki_subjects
    ...
    # print("ammount aki_subjects",len(sepsis_filtered_unique)) #14153 mensen hebben een waarde datum voor dod
    ...
    # print("ammount subject_id's with dod en AKI_time value",amount)

    # Filter alleen rijen met dod én AKI_time
    alive_subjects = merged.dropna(subset=["AKI_time"]).copy()
    # print("Aantal overgebleven subject_ids:", len(alive_subjects))
    ...
    # alive_subjects.to_csv("daysuntildeathwithoutnegative.csv", index=False)
    ...
    # print("Aantal dat binnen 90 dagen na AKI overlijdt:", num_died_90d)
